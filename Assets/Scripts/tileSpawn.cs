...
public class tileSpawn : MonoBehaviour {
	...
	void Update () {
		...
		{
			spawn1pos = new Vector2(-3.964183f, transform.position.y + 2);
			spawn2pos = new Vector2(-2.461335f, transform.position.y + 2);
			spawn3pos = new Vector2(-0.9372464f, transform.position.y + 2);
			spawn4pos = new Vector2(0.583663f, transform.position.y + 2);
